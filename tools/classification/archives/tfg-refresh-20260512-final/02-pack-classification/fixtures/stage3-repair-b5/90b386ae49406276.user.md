# Items to classify
{
  "items": [
    {
      "id": "primitive_creatures:tt_5",
      "namespace": "primitive_creatures",
      "display_name": "Small Shard",
      ...
      "loot_source_examples": [
        ...
        "primitive_creatures:entities/musselwarden",
    ...
    {
      "id": "primitive_creatures:viloger_10_spawn_egg",
      "namespace": "primitive_creatures",
      "display_name": "Mercenary Spawn Egg",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "c:hidden_from_recipe_viewers"
    ...
    {
      "id": "primitive_creatures:w_22",
      "namespace": "primitive_creatures",
      "display_name": "the poisonous shell",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
    ...
    {
      "id": "primitive_creatures:w_3",
      "namespace": "primitive_creatures",
      "display_name": "the withered shell",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
    ...
    {
      "id": "primitive_creatures:wiloger_spawn_egg",
      "namespace": "primitive_creatures",
      "display_name": "Beast Tamer Spawn Egg",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "c:hidden_from_recipe_viewers"
