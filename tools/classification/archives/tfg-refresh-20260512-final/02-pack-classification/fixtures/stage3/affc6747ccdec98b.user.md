# Items to classify
{
  "items": [
    {
      "id": "gtceu:iv_machine_casing",
      "namespace": "gtceu",
      "display_name": "IV Machine Casing",
      ...
      "model_parents": [
        "item/iv_machine_casing",
        "block/iv_machine_casing",
      ...
      "loot_source_examples": [
        "gtceu:blocks/iv_machine_casing"
      ],
      "block_context": {
        "block_id": "gtceu:iv_machine_casing",
        "block_tags": [
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§9IV §fMachine Hull",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/iv_machine_hull",
        "block/machine/iv_machine_hull",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_machine_hull",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_iv_mixer",
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Muffler Hatch §9IV",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/iv_muffler_hatch",
        "block/machine/iv_muffler_hatch",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_muffler_hatch",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "gtceu:iv_naquadah_alloy_buzzsaw",
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Buzzsaw (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "204,800 §aCrafting Uses"
        },
        {
          "source": "runtime-tooltip",
          "text": "204,799 §eTotal Durability"
        },
        {
          "source": "runtime-tooltip",
          "text": "204,800 §bDurability"
        },
        {
          "source": "runtime-tooltip",
    ...
    {
      "id": "gtceu:iv_naquadah_alloy_chainsaw",
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Chainsaw (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
    ...
    {
      "id": "gtceu:iv_naquadah_alloy_drill",
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Drill (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "286,719 §eTotal Durability"
        },
        {
          "source": "runtime-tooltip",
          "text": "286,720 §bDurability"
        },
        {
          "source": "runtime-tooltip",
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Screwdriver (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "gtceu:iv_naquadah_alloy_wire_cutter",
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Wire Cutter (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "gtceu:iv_naquadah_alloy_wrench",
      "namespace": "gtceu",
      "display_name": "Naquadah Alloy Wrench (IV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "gtceu:iv_ore_washer",
      "namespace": "gtceu",
      "display_name": "§9Elite Ore Washer §r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "semantic_text": [
        {
          "source": "runtime-tooltip",
          "text": "§7Repurposed Laundry-Washer I-360"
        },
        {
          "source": "runtime-tooltip",
          "text": "§aVoltage IN: §f8,192 EU/t (§9IV§f)"
    ...
    },
    {
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_iv_output_bus",
    ...
    },
    {
      ...
      "model_parents": [
        "item/iv_output_hatch",
        "block/machine/iv_output_hatch",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_output_hatch",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§9IV Quadruple Output Hatch",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/iv_output_hatch_4x",
        "block/machine/iv_output_hatch_4x",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_output_hatch_4x",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§9IV Nonuple Output Hatch",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 2,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_iv_output_hatch_9_x",
      ...
      "model_parents": [
        "item/iv_output_hatch_9x",
        "block/machine/iv_output_hatch_9x",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_output_hatch_9x",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Elite Parallel Control Hatch",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/iv_parallel_hatch",
        "block/machine/iv_parallel_hatch",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_parallel_hatch",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        {
          "source": "runtime-tooltip",
          "text": "Allows to run up to 4 recipes in parallel."
        },
        {
          "source": "runtime-tooltip",
    ...
    {
      "id": "gtceu:iv_polarizer",
      "namespace": "gtceu",
      "display_name": "§9Elite Polarizer §r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
    ...
    {
      "id": "gtceu:iv_quantum_chest",
      "namespace": "gtceu",
      "display_name": "Quantum Chest V",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "create:non_movable",
      ...
      "recipe_ingredient_examples": [
        ...
        "gtceu:shapeless/quantum_chest_nbt_5"
      ],
      "recipe_output_examples": [
        "gtceu:shaped/quantum_chest_iv",
        "gtceu:shapeless/quantum_chest_nbt_5"
      ...
      "model_parents": [
        "item/iv_quantum_chest",
        "block/machine/iv_quantum_chest",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_quantum_chest",
        "block_tags": [
          "create:non_movable",
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§6Item Capacity: §f64,000,000 items"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    },
    {
      ...
      "recipe_ingredient_examples": [
        ...
        "gtceu:shapeless/quantum_tank_nbt_5"
      ],
      "recipe_output_examples": [
      ...
      "model_parents": [
        "item/iv_quantum_tank",
        "block/machine/iv_quantum_tank",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_quantum_tank",
        "block_tags": [
          "create:non_movable",
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§9Fluid Capacity: §f64,000,000 mB"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:iv_rock_crusher",
      "namespace": "gtceu",
      "display_name": "§9Elite Rock Crusher §r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_iv_rock_crusher"
      ],
      "recipe_output_examples": [
        "gtceu:shaped/iv_rock_crusher"
      ],
      "model_parents": [
        "item/iv_rock_crusher",
        "block/machine/iv_rock_crusher",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_rock_crusher",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        {
          "source": "runtime-tooltip",
          "text": "§7Cryogenic Magma Solidifier R-8200"
        },
        {
          "source": "runtime-tooltip",
          "text": "§aVoltage IN: §f8,192 EU/t (§9IV§f)"
    ...
    {
      "id": "gtceu:iv_rotor_holder",
      "namespace": "gtceu",
      "display_name": "§9IV Rotor Holder",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/iv_rotor_holder",
        "block/machine/iv_rotor_holder",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:iv_rotor_holder",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
