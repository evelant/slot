# Items to classify
{
  "items": [
    {
      "id": "tfg:antipoison_tablet",
      "namespace": "tfg",
      "display_name": "Antipoison Tablet",
      ...
      "semantic_text": [
        {
          ...
          "text": "§9Cures All Active Harmful Effects"
        },
        {
          "source": "runtime-tooltip",
    ...
    },
    {
      "id": "tfg:apt_dust",
      "namespace": "tfg",
      "display_name": "Ammonium Paratungstate Dust",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:dusts",
      ...
      "recipe_output_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_apt_gem",
        "gtceu:shaped/small_dust_assembling_apt",
        "gtceu:shaped/tiny_dust_assembling_apt",
        "tfg:quern/apt_gem_to_dust"
      ],
      "model_parents": [],
      "creative_tabs": [
        "tfg:tfg"
    ...
    },
    {
      "id": "tfg:apt_gem",
      "namespace": "tfg",
      "display_name": "Ammonium Paratungstate",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "balm:gems",
    ...
    {
      "id": "tfg:argillite_support",
      "namespace": "tfg",
      "display_name": "Argillite Support",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:argillite_support",
        "block_tags": [
    ...
    {
      "id": "tfg:argon_enriched_atmosphere_bucket",
      "namespace": "tfg",
      "display_name": "Argon Enriched Atmosphere Bucket",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
