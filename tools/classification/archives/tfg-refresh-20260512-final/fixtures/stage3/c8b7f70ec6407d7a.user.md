# Items to classify
{
  "items": [
    {
      "id": "tfg:hot_rene_41_ingot",
      "namespace": "tfg",
      "display_name": "Hot René-41 Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/rene_41",
    ...
    {
      "id": "tfg:hot_rough_silicon_carbide_ingot",
      "namespace": "tfg",
      "display_name": "Hot Rough Silicon Carbide Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/rough_silicon_carbide",
        "tfchotornot:hot_whitelist"
      ],
      "minecraft_tag_membership": "resolved_runtime",
      "processing_in": [],
    ...
    {
      "id": "tfg:hot_tungsten_bismuth_oxide_composite_ingot",
      "namespace": "tfg",
      "display_name": "Hot Tungsten-Bismuth Oxide Composite Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/tungsten_bismuth_oxide_composite",
        "tfchotornot:hot_whitelist"
      ],
      "minecraft_tag_membership": "resolved_runtime",
      "processing_in": [],
    ...
    {
      "id": "tfg:hot_weak_mo_si_b_ingot",
      "namespace": "tfg",
      "display_name": "Hot Weak Molybdenum–Silicon–Boron Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/weak_mo_si_b",
        "tfchotornot:hot_whitelist"
      ],
      "minecraft_tag_membership": "resolved_runtime",
      "processing_in": [],
    ...
    {
      "id": "tfg:hot_worked_mo_si_b_ingot",
      "namespace": "tfg",
      "display_name": "Hot Worked Molybdenum–Silicon–Boron Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/worked_mo_si_b",
        "tfchotornot:hot_whitelist"
      ],
      "minecraft_tag_membership": "resolved_runtime",
      "processing_in": [],
    ...
    {
      "id": "tfg:hot_zirconium_diboride_ingot",
      "namespace": "tfg",
      "display_name": "Hot Zirconium Diboride Ingot",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:hot_ingots",
        "forge:hot_ingots/zirconium_diboride",
        "tfchotornot:hot_whitelist"
      ],
      "minecraft_tag_membership": "resolved_runtime",
      "processing_in": [],
    ...
    {
      "id": "tfg:hv_aircraft_engine",
      "namespace": "tfg",
      "display_name": "HV Aircraft Engine",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "+45% engine power"
        },
        {
          "source": "runtime-tooltip",
          "text": "+25% fuel requirement"
        },
        {
          "source": "runtime-tooltip",
    ...
    {
      "id": "tfg:hv_aqueous_accumulator",
      "namespace": "tfg",
      "display_name": "§6Advanced Aqueous Accumulator II§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/hv_aqueous_accumulator",
        "block/machine/hv_aqueous_accumulator",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_aqueous_accumulator",
        "block_tags": [
    ...
    {
      "id": "tfg:hv_boron_carbide_buzzsaw",
      "namespace": "tfg",
      "display_name": "Boron Carbide Buzzsaw (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "-1/-1 EU - Tier §6HV"
        },
        {
          "source": "runtime-tooltip",
          "text": "55,170 §aCrafting Uses"
        },
        {
          "source": "runtime-tooltip",
    ...
    {
      "id": "tfg:hv_boron_carbide_chainsaw",
      "namespace": "tfg",
      "display_name": "Boron Carbide Chainsaw (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
    ...
    {
      "id": "tfg:hv_boron_carbide_drill",
      "namespace": "tfg",
      "display_name": "Boron Carbide Drill (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "91,949 §eTotal Durability"
        },
        {
          "source": "runtime-tooltip",
          "text": "91,950 §bDurability"
        },
        {
          "source": "runtime-tooltip",
    ...
    },
    {
      ...
      "namespace": "tfg",
      "display_name": "Boron Carbide Screwdriver (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "tfg:hv_boron_carbide_wire_cutter",
      "namespace": "tfg",
      "display_name": "Boron Carbide Wire Cutter (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "tfg:hv_boron_carbide_wrench",
      "namespace": "tfg",
      "display_name": "Boron Carbide Wrench (HV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    },
    {
      "id": "tfg:hv_food_oven",
      "namespace": "tfg",
      "display_name": "§6Advanced Electric Oven II§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_hv_food_oven"
      ],
      "recipe_output_examples": [
    ...
    {
      "id": "tfg:hv_food_processor",
      "namespace": "tfg",
      "display_name": "§6Advanced Food Processor II§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/hv_food_processor",
        "block/machine/hv_food_processor",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_food_processor",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "tfg:hv_food_refrigerator",
      "namespace": "tfg",
      "display_name": "§6Advanced Refrigerator II§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/hv_food_refrigerator",
        "block/machine/hv_food_refrigerator",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_food_refrigerator",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§6Item Slots: §f45"
        },
        {
          "source": "runtime-tooltip",
          "text": "§7Consumes§r 150 EU/t §7while active to keep your food fresh.§r"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "tfg:hv_gas_pressurizer",
      "namespace": "tfg",
      "display_name": "§6Advanced Gas Pressurizer II§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/hv_gas_pressurizer",
        "block/machine/hv_gas_pressurizer",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_gas_pressurizer",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "tfg:hv_railgun_item_loader_in",
      "namespace": "tfg",
      "display_name": "§6HV Interplanetary Railgun Input Bus§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_ingredient_examples": [
        "tfg:shaped/railgun_output_convert_3"
      ],
      "recipe_output_examples": [
        "tfg:shaped/railgun_input_bus_create_3",
        "tfg:shaped/railgun_input_convert_3"
      ],
      "model_parents": [
        "item/hv_railgun_item_loader_in",
        "block/machine/hv_railgun_item_loader_in",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_railgun_item_loader_in",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "tfg:hv_railgun_item_loader_out",
      "namespace": "tfg",
      "display_name": "§6HV Interplanetary Railgun Output Bus§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/hv_railgun_item_loader_out",
        "block/machine/hv_railgun_item_loader_out",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hv_railgun_item_loader_out",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "tfg",
      "display_name": "HV Universal Circuit",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "gtceu:circuits",
    ...
    {
      "id": "tfg:hydroponics_facility",
      "namespace": "tfg",
      "display_name": "Hydroponics Facility",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/hydroponics_facility",
        "block/machine/hydroponics_facility",
        "block/block"
      ],
      "creative_tabs": [
        "tfg:tfg"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "tfg:hydroponics_facility",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        {
          "source": "runtime-tooltip",
          "text": "§7§oFarming the loOOng way§r"
        },
        {
          "source": "runtime-tooltip",
          "text": "§7The upgraded form of the EGH! The Hydroponics Facility boosts greenhouse output chances and has no restrictions on being oxygenated.§r"
        },
        {
          "source": "runtime-tooltip",
    ...
    {
      "id": "tfg:hydroxide_decomposition_off_gas_bucket",
      "namespace": "tfg",
      "display_name": "Hydroxide Decomposition Off-Gas Bucket",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    },
    {
      ...
      "namespace": "tfg",
      "display_name": "Felsic Igneous Dust",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:dusts",
        "forge:dusts/igneous_felsic",
    ...
    },
    {
      ...
      "namespace": "tfg",
      "display_name": "Intermediate Igneous Dust",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:dusts",
        "forge:dusts/igneous_intermediate",
        "sns:allowed_in_ore_sack",
        "tfg:stone_dusts"
      ],
      "minecraft_tag_membership": "resolved_runtime",
