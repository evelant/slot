  ...
  "items": [
    {
      "id": "gtceu:ev_scanner",
      "namespace": "gtceu",
      "display_name": "§5Advanced Scanner III§r",
    ...
    },
    {
      "id": "gtceu:ev_sifter",
      "namespace": "gtceu",
      "display_name": "§5Advanced Sifter III§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_ev_sifter"
      ],
      "recipe_output_examples": [
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Extreme Voltage Solar Panel",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§aVoltage OUT: §f2048 EU/t (§5EV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Very Light ⇲ Very Small"
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§5EV 64A Substation Energy Hatch",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_substation_input_hatch_64a",
        "block/machine/ev_substation_input_hatch_64a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_substation_input_hatch_64a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§5EV 64A Substation Dynamo Hatch",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_substation_output_hatch_64a",
        "block/machine/ev_substation_output_hatch_64a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_substation_output_hatch_64a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "gtceu:ev_super_chest",
      "namespace": "gtceu",
      "display_name": "Super Chest IV",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "create:non_movable",
      ...
      "recipe_ingredient_examples": [
        "gtceu:shapeless/super_chest_nbt_4"
      ],
      "recipe_output_examples": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§6Item Capacity: §f32,000,000 items"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    },
    {
      ...
      "recipe_ingredient_examples": [
        ...
        "gtceu:shapeless/super_tank_nbt_4"
      ],
      "recipe_output_examples": [
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§9Fluid Capacity: §f32,000,000 mB"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:ev_thermal_centrifuge",
      "namespace": "gtceu",
      "display_name": "§5Advanced Thermal Centrifuge III§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "model_parents": [
        "item/ev_thermal_centrifuge",
        "block/machine/ev_thermal_centrifuge",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_thermal_centrifuge",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "§5Extreme Voltage§r Power Transformer",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 0,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_ev_transformer_16_a"
      ],
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_transformer_16a",
        "block/machine/ev_transformer_16a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_transformer_16a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§aTransform Down: §f16A 8,192 EU (§9IV§f) -> 64A 2,048 EU (§5EV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "§cTransform Up: §f64A 2,048 EU (§5EV§f) -> 16A 8,192 EU (§9IV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:ev_transformer_1a",
      "namespace": "gtceu",
      "display_name": "§5Extreme Voltage§r Transformer",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 1,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_ev_transformer_1_a"
      ],
      "recipe_output_examples": [
        "gtceu:shaped/ev_transformer_1a"
      ],
      "model_parents": [
        "item/ev_transformer_1a",
        "block/machine/ev_transformer_1a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_transformer_1a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§aTransform Down: §f1A 8,192 EU (§9IV§f) -> 4A 2,048 EU (§5EV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "§cTransform Up: §f4A 2,048 EU (§5EV§f) -> 1A 8,192 EU (§9IV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:ev_transformer_2a",
      "namespace": "gtceu",
      "display_name": "§5Extreme Voltage§r Hi-Amp (2x) Transformer",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_transformer_2a",
        "block/machine/ev_transformer_2a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_transformer_2a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§aTransform Down: §f2A 8,192 EU (§9IV§f) -> 8A 2,048 EU (§5EV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "§cTransform Up: §f8A 2,048 EU (§5EV§f) -> 2A 8,192 EU (§9IV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:ev_transformer_4a",
      "namespace": "gtceu",
      "display_name": "§5Extreme Voltage§r Hi-Amp (4x) Transformer",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "recipe_output_count": 0,
      "recipe_ingredient_examples": [
        "greate:milling/integration/gtceu/macerator/macerate_ev_transformer_4_a"
      ],
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_transformer_4a",
        "block/machine/ev_transformer_4a",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_transformer_4a",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "§aTransform Down: §f4A 8,192 EU (§9IV§f) -> 16A 2,048 EU (§5EV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "§cTransform Up: §f16A 2,048 EU (§5EV§f) -> 4A 8,192 EU (§9IV§f)"
        },
        {
          "source": "runtime-tooltip",
          "text": "⚖ Light ⇲ Small"
    ...
    {
      "id": "gtceu:ev_tungsten_carbide_buzzsaw",
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Buzzsaw (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Chainsaw (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
    ...
    {
      "id": "gtceu:ev_tungsten_carbide_drill",
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Drill (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:tools",
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Screwdriver (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "gtceu:ev_tungsten_carbide_wire_cutter",
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Wire Cutter (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    {
      "id": "gtceu:ev_tungsten_carbide_wrench",
      "namespace": "gtceu",
      "display_name": "Tungsten Carbide Wrench (EV)",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
    ...
    },
    {
      ...
      "namespace": "gtceu",
      "display_name": "Small Vanadium Battery",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "gtceu:batteries",
      ...
      "semantic_text": [
        ...
        {
          "source": "runtime-tooltip",
          "text": "0/10,240,000 EU§7 - Tier §5EV §7(0/250 seconds remaining§7)"
        },
        {
          "source": "runtime-tooltip",
        ...
        {
          "source": "lang",
          "key": "item.gtceu.ev_vanadium_battery.tooltip",
    ...
    {
      "id": "gtceu:ev_voltage_coil",
      "namespace": "gtceu",
      "display_name": "Extreme Voltage Coil",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
      ...
      "semantic_text": [
        ...
        {
          "source": "lang",
          "key": "item.gtceu.ev_voltage_coil.tooltip",
          "text": "Extreme Coil"
        }
      ],
      "component_highlights": {
    ...
    {
      "id": "gtceu:ev_wiremill",
      "namespace": "gtceu",
      "display_name": "§5Advanced Wiremill III§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [],
      "minecraft_tag_membership": "resolved_runtime",
    ...
    {
      "id": "gtceu:ev_world_accelerator",
      "namespace": "gtceu",
      "display_name": "§5Advanced World Accelerator III§r",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "c:hidden_from_recipe_viewers"
      ...
      "recipe_output_examples": [],
      "model_parents": [
        "item/ev_world_accelerator",
        "block/machine/ev_world_accelerator",
        "block/block"
      ],
      "creative_tabs": [
        "gtceu:machine"
      ...
      "loot_source_examples": [],
      "block_context": {
        "block_id": "gtceu:ev_world_accelerator",
        "requires_correct_tool": true
      },
      "lore": [],
      "semantic_text": [
    ...
    {
      "id": "gtceu:explosion_hazard_sign_block",
      "namespace": "gtceu",
      "display_name": "Explosion Hazard Sign Block",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
      ...
      "model_parents": [
        "item/explosion_hazard_sign_block",
        "block/explosion_hazard_sign_block",
        "block/cube_all"
      ],
      "creative_tabs": [
        "gtceu:decoration"
      ...
      "loot_source_count": 1,
      "loot_source_examples": [
        "gtceu:blocks/explosion_hazard_sign_block"
      ],
      "block_context": {
        "block_id": "gtceu:explosion_hazard_sign_block",
        "block_tags": [
          "forge:mineable/wrench",
          "gtceu:mineable/pickaxe_or_wrench"
        ],
    ...
    {
      "id": "gtceu:exquisite_almandine_gem",
      "namespace": "gtceu",
      "display_name": "Exquisite Almandine",
      "minecraft_tags_direct": [],
      "minecraft_tags_inherited": [],
      "minecraft_tags_resolved": [
        "forge:exquisite_gems",
        "forge:exquisite_gems/almandine",
