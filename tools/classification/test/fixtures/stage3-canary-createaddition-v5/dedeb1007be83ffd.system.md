...
- `createaddition:electricity` — Power generation, storage, and regulation equipment
- `createaddition:energy_conversion` — Conversion between kinetic and electrical energy
- `createaddition:power_transmission` — Wires, cables, and connectors for power distribution
- `createaddition:mechanical_processing` — Kinetic machines for crafting and material processing
- `createaddition:biofuel` — Combustible organic materials for fuel and energy
