...
- allowed: undead, arthropod, aquatic, illager, piglin, boss:ender_dragon, boss:warden, boss:wither, boss:elder_guardian, inflicts_poison, inflicts_slowness, inflicts_weakness, inflicts_wither, bonus_in_water, bonus_in_daylight, fall_bonus_damage
...
# Suggested mod_subsystem vocabulary
...
- `ae2:me_network` — Cables, covers, tunnels, and wireless components that form the network backbone
- `ae2:autocrafting` — Crafting CPUs, monitors, and storage blocks for automated item crafting
- `ae2:storage` — Storage cells and drives for storing items and fluids
- `ae2:external_io` — Buses for transferring items between ME network and external storage
- `ae2:processing` — Specialized machines like inscribers and quartz cutters for item processing
- `ae2:energy` — Power infrastructure for supplying energy to the ME network
- `ae2:spatial_storage` — Quantum rings and components for spatial/dimensional storage
