...
- `sophisticatedstorage:storage_container` — Storage blocks: barrels, chests, and shulker boxes in various tiers
- `sophisticatedstorage:storage_tier_upgrade` — Items that upgrade container tiers and materials
- `sophisticatedstorage:storage_functional_upgrade` — Upgrades that add automation, processing, or behavior modifications
- `sophisticatedstorage:storage_network` — Components for linking and controlling multiple containers
- `sophisticatedstorage:storage_customization` — Cosmetic personalization and stack modification items
