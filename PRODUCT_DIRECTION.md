...
For current core architecture, see [ARCHITECTURE.md](ARCHITECTURE.md).
For normative behavior, see [SPEC.md](SPEC.md).
For the current engineering sequence, see
...
Experiment with how collections, loadouts, recents, favorites, and planning
metadata should be surfaced without overwhelming ordinary browsing.
