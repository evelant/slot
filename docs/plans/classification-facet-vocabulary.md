...
- built-in high-specificity sections such as Ingots, Wood, Seeds, Crops,
  Plants, Clay & Pottery, Mob Drops, Stairs, Slabs, Food, Tools, and Storage
  keep ownership of the main home; vocabulary values for
...
- curation and item prompts should include the protected built-in section list
  ...
  `Crops`, `Plants`, `Clay & Pottery`, and `Mob Drops` are protected stock
  sections for their obvious item families; `Materials` is not protected
