...
7. **[Milestones](#milestones)** — the execution order. Milestones 1–3 complete (stage-1 vanilla extractor is in [reference/classification/pipeline/](../../reference/classification/pipeline/)); milestone 4 (stage-2 deterministic rules) is the next concrete work.
...
4. **Deterministic facet extractor** (stage 2) against vanilla. Measure coverage — what fraction of items have each facet assigned deterministically?
