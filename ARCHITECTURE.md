...
For product direction, see [PRODUCT_DIRECTION.md](PRODUCT_DIRECTION.md).
For user-visible behavior, see [SPEC.md](SPEC.md).
For the current execution sequence, see
...
`InventoryActionScope` expresses how broad a row-driven transfer should be:
...
- an explicit action kind and scope
