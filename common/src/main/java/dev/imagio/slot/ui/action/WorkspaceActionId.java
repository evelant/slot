...
public enum WorkspaceActionId {
    ...
    SET_CHEST_ROLE_AT_POS("slot.workspace.set_chest_role_at_pos", STRING, INTEGER, INTEGER, INTEGER, STRING),
    ...
    SET_RECIPE_INGREDIENT_FILTER("slot.workspace.set_recipe_ingredient_filter", STRING),
    ...
    CREATE_WORKFLOW_TAB("slot.workspace.create_workflow_tab", STRING),
    CREATE_KIT_VARIANT("slot.workspace.create_kit_variant", STRING, STRING),
    ...
    SET_KIT_MEMBER("slot.workspace.set_kit_member", STRING, STRING, STRING, STRING, INTEGER),
    SET_KIT_ACCEPTED_INPUT("slot.workspace.set_kit_accepted_input", STRING, STRING, STRING, STRING, STRING, STRING, INTEGER),
    ...
    TAKE_ITEMS_BY_IDENTITY("slot.workspace.take_items_by_identity", STRING, STRING, STRING, INTEGER),
    ...
    CRAFT_RUN_STAGE_ENTRY("slot.workspace.craft_run_stage_entry", STRING),
    CRAFT_RUN_ADJUST_ENTRY("slot.workspace.craft_run_adjust_entry", STRING, INTEGER),
    CRAFT_RUN_SELECT_INGREDIENT("slot.workspace.craft_run_select_ingredient", STRING, STRING, STRING, STRING, STRING),
    CRAFT_RUN_REMOVE_ENTRY("slot.workspace.craft_run_remove_entry", STRING),
    ...
    MOVE_IDENTITY_TO_MAIN_INVENTORY("slot.workspace.move_identity_to_main_inventory", STRING, STRING, STRING),
    MOVE_IDENTITY_TO_BACKPACK("slot.workspace.move_identity_to_backpack", STRING, STRING, STRING),
    ...
    DEPOSIT_ITEMS_HOME_TO_LINKED_CHEST("slot.workspace.deposit_items_home_to_linked_chest", STRING, STRING, STRING, INTEGER),
    ...
    CROSS_SURFACE_QUICK_MOVE_HOTBAR("slot.workspace.cross_surface_quick_move_hotbar", INTEGER),
