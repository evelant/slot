...
public final class WorkspaceHelpContent {
    ...
    private static final List<Line> KEYS = List.of(
            ...
            new Line("Tab",
                    "Put hovered item on a free hotbar slot.",
                    "Search confirm uses this for quick equip."),
            new Line("Shift+Tab",
                    "Focus the wall on the hovered item.",
                    "Useful when a ghost or search result is off-screen."),
            new Line("1-9",
