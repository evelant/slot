...
public final class WorkspaceHelpContent {
    ...
    private static final List<Line> GESTURES = List.of(
            ...
            new Line("Shift+right-click",
                    "Smart transfer against nearby storage for that item's home.",
                    "Use the keyboard shortcuts when you need an exact direction."),
    ...
    private static final List<Line> KEYS = List.of(
            ...
            new Line("A / D",
                    "Take or put a hovered stack.",
                    "A pulls from nearby storage; D stores carried items."),
            new Line("Q / E",
                    "Take or put one hovered item.",
                    "Q pulls one; E stores one."),
            new Line("Shift+A / Shift+D",
                    "Take or put all hovered items.",
                    "Uses the exact hovered identity."),
            new Line("Ctrl+A / Ctrl+D",
                    "Take or put five hovered stacks.",
                    "All of these card-transfer keys are configurable."),
            new Line("X / Shift+X",
    ...
    private static final List<Line> STORAGE_ROLES = List.of(
            ...
            new Line("Input",
                    "Visible and searchable; does not learn homes.",
                    "Lowest take priority; accepts put only while open."),
            new Line("Output",
                    "Visible and searchable; does not learn homes.",
                    "Highest take priority; accepts put only while open."),
            new Line("Ignore",
